    ...
    void insert() {
        ...
        transactionTemplate.executeWithoutResult(status -> {
            for(int i = 0; i < BULK_INSERT_SIZE; i++){
                // BULK_INSERT_SIZE만큼 반복하면서 Article 객체를 생성하여 DB에 저장(persist)합니다.
                // snowflake.nextId()로 고유 ID 부여
                // "title" + i와 "content" + i는 예시용 제목/내용
                // 1L, 1L은 예를 들어 작성자 ID, 게시판 ID 등으로 보입니다.
